...
public class LargeThermalCentrifugeInfo extends MultiblockInfoPage {
	...
	public MultiblockControllerBase getController() {
		return NPUTileEntities.LARGE_THERMAL_CENTRIFUGE;
	}
	...
	public List<MultiblockShapeInfo> getMatchingShapes() {
		...
		for (BlockWireCoil.CoilType coilType : BlockWireCoil.CoilType.values()) {
			shapeInfo.add(MultiblockShapeInfo.builder()
					...
					.where('S', NPUTileEntities.LARGE_THERMAL_CENTRIFUGE, EnumFacing.SOUTH)
					.where('C', MetaBlocks.WIRE_COIL.getState(coilType))
					.where('X', NPUMetaBlocks.METAL_CASING.getState(NPUMetalCasing.MetalCasingType.RED_STEEL_CASING))
