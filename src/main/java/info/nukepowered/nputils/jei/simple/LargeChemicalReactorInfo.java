...
public class LargeChemicalReactorInfo extends MultiblockInfoPage {
	...
	public MultiblockControllerBase getController() {
		return NPUTileEntities.LARGE_CHEMICAL_REACTOR;
	}
	...
	public List<MultiblockShapeInfo> getMatchingShapes() {
		...
		for (BlockWireCoil.CoilType coilType : BlockWireCoil.CoilType.values()) {
			shapeInfo.add(MultiblockShapeInfo.builder()
					...
					.where('S', NPUTileEntities.LARGE_CHEMICAL_REACTOR, EnumFacing.SOUTH)
					.where('C', MetaBlocks.WIRE_COIL.getState(coilType))
					.where('X', NPUMetaBlocks.MULTIBLOCK_CASING.getState(NPUMultiblockCasing.CasingType.CHEMICALLY_INERT))
