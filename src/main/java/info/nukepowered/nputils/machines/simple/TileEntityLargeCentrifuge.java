...
public class TileEntityLargeCentrifuge extends LargeSimpleRecipeMapMultiblockController {
	...
	public TileEntityLargeCentrifuge(ResourceLocation metaTileEntityId) {
		super(metaTileEntityId, RecipeMaps.CENTRIFUGE_RECIPES, 90, 225, 100, 6);
	}
	...
	public IBlockState getCasingState() {
		return NPUMetaBlocks.METAL_CASING.getState(NPUMetalCasing.MetalCasingType.TUMBAGA);
	}

	@Override
	public ICubeRenderer getBaseTexture(IMultiblockPart sourcePart) {
		return NPUTextures.TUMBAGA;
	}
