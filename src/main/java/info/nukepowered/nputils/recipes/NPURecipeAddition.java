...
//    };
	...
	public static void init() {
        ...
        if (NPUConfig.enableRealisticMotorCraft) {
        	...
        	RecipeMaps.ASSEMBLER_RECIPES.recipeBuilder().duration(80).EUt(30).inputs(NPUMetaItems.ROTOR_MV.getStackForm(), NPUMetaItems.STATOR_MV.getStackForm(), NPUMetaItems.MOTOR_HULL_MV.getStackForm()).outputs(MetaItems.ELECTRIC_MOTOR_MV.getStackForm()).buildAndRegister();
        	RecipeMaps.ASSEMBLER_RECIPES.recipeBuilder().duration(160).EUt(120).inputs(NPUMetaItems.ROTOR_HV.getStackForm(), NPUMetaItems.STATOR_HV.getStackForm(), NPUMetaItems.MOTOR_HULL_HV.getStackForm()).outputs(MetaItems.ELECTRIC_MOTOR_HV.getStackForm()).buildAndRegister();
        	RecipeMaps.ASSEMBLER_RECIPES.recipeBuilder().duration(320).EUt(480).inputs(NPUMetaItems.ROTOR_EV.getStackForm(), NPUMetaItems.STATOR_EV.getStackForm(), NPUMetaItems.MOTOR_HULL_EV.getStackForm()).outputs(MetaItems.ELECTRIC_MOTOR_EV.getStackForm()).buildAndRegister();
        	RecipeMaps.ASSEMBLER_RECIPES.recipeBuilder().duration(640).EUt(960).inputs(NPUMetaItems.ROTOR_IV.getStackForm(), NPUMetaItems.STATOR_IV.getStackForm(), NPUMetaItems.MOTOR_HULL_IV.getStackForm()).outputs(MetaItems.ELECTRIC_MOTOR_IV.getStackForm()).buildAndRegister();
        	RecipeMaps.ASSEMBLER_RECIPES.recipeBuilder().duration(700).EUt(3840).inputs(NPUMetaItems.ROTOR_LuV.getStackForm(), NPUMetaItems.STATOR_LuV.getStackForm(), NPUMetaItems.MOTOR_HULL_LuV.getStackForm()).outputs(MetaItems.ELECTRIC_MOTOR_LUV.getStackForm()).buildAndRegister();
        	RecipeMaps.ASSEMBLER_RECIPES.recipeBuilder().duration(800).EUt(7680).inputs(NPUMetaItems.ROTOR_ZPM.getStackForm(), NPUMetaItems.STATOR_ZPM.getStackForm(), NPUMetaItems.MOTOR_HULL_ZPM.getStackForm()).outputs(MetaItems.ELECTRIC_MOTOR_ZPM.getStackForm()).buildAndRegister();
        	RecipeMaps.ASSEMBLER_RECIPES.recipeBuilder().duration(900).EUt(15360).inputs(NPUMetaItems.ROTOR_UV.getStackForm(), NPUMetaItems.STATOR_UV.getStackForm(), NPUMetaItems.MOTOR_HULL_UV.getStackForm()).outputs(MetaItems.ELECTRIC_MOTOR_UV.getStackForm()).buildAndRegister();
        	
        	//Motor components recycle
			RecipeMaps.MACERATOR_RECIPES.recipeBuilder().duration(30).EUt(12).inputs(NPUMetaItems.MAGNETICALLY_PERMEABLE_PLATE_SET.getStackForm()).outputs(OreDictUnifier.get(OrePrefix.dustSmall, NPUMaterials.ElectricalSteel, 2)).buildAndRegister();
...
//        	RecipeMaps.MIXER_RECIPES.recipeBuilder().duration(40).EUt(16).inputs(OreDictUnifier.get(OrePrefix.dust, Materials.Steel, 26)).input(OrePrefix.dust, Materials.Silicon).outputs(OreDictUnifier.get(OrePrefix.dust, NPUMaterials.ElectricalSteel, 27)).buildAndRegister();
        ...
        for (MaterialStack stack : solderingList) {
            ...
            NPURecipeMaps.CIRCUIT_ASSEMBLER_RECIPES.recipeBuilder().duration(800).EUt(28).inputs(MetaItems.GOOD_INTEGRATED_CIRCUIT_MV.getStackForm(2), MetaItems.INTEGRATED_LOGIC_CIRCUIT.getStackForm(3), MetaItems.RANDOM_ACCESS_MEMORY.getStackForm(), MetaItems.TRANSISTOR.getStackForm(4), OreDictUnifier.get(OrePrefix.wireFine, Materials.Electrum, 16)).fluidInputs(material.getFluid(72 * multiplier)).outputs(NPUMetaItems.ADVANCED_CIRCUIT.getStackForm()).buildAndRegister();
            NPURecipeMaps.CIRCUIT_ASSEMBLER_RECIPES.recipeBuilder().duration(800).EUt(28).inputs(MetaItems.GOOD_INTEGRATED_CIRCUIT_MV.getStackForm(2), MetaItems.INTEGRATED_LOGIC_CIRCUIT.getStackForm(3), MetaItems.RANDOM_ACCESS_MEMORY.getStackForm(), MetaItems.SMD_TRANSISTOR.getStackForm(4), OreDictUnifier.get(OrePrefix.wireFine, Materials.Electrum, 16)).fluidInputs(material.getFluid(72 * multiplier)).outputs(NPUMetaItems.ADVANCED_CIRCUIT.getStackForm()).buildAndRegister();
        ...
        RecipeMaps.CHEMICAL_RECIPES.recipeBuilder().duration(600).EUt(30).inputs(MetaItems.PHENOLIC_BOARD.getStackForm()).input(OrePrefix.foil, Materials.Gold, 4).fluidInputs(Materials.SodiumPersulfate.getFluid(200)).outputs(NPUMetaItems.GOOD_PHENOLIC_BOARD.getStackForm()).buildAndRegister();
        RecipeMaps.CHEMICAL_RECIPES.recipeBuilder().duration(600).EUt(30).inputs(MetaItems.PHENOLIC_BOARD.getStackForm()).input(OrePrefix.foil, Materials.Gold, 4).fluidInputs(NPUMaterials.IronChloride.getFluid(100)).outputs(NPUMetaItems.GOOD_PHENOLIC_BOARD.getStackForm()).buildAndRegister();
        RecipeMaps.CHEMICAL_RECIPES.recipeBuilder().duration(800).EUt(30).inputs(MetaItems.PLASTIC_BOARD.getStackForm()).input(OrePrefix.foil, Materials.Copper, 6).fluidInputs(Materials.SodiumPersulfate.getFluid(500)).outputs(NPUMetaItems.GOOD_PLASTIC_BOARD.getStackForm()).buildAndRegister();
        RecipeMaps.CHEMICAL_RECIPES.recipeBuilder().duration(800).EUt(30).inputs(MetaItems.PLASTIC_BOARD.getStackForm()).input(OrePrefix.foil, Materials.Copper, 6).fluidInputs(NPUMaterials.IronChloride.getFluid(250)).outputs(NPUMetaItems.GOOD_PLASTIC_BOARD.getStackForm()).buildAndRegister();
        RecipeMaps.CHEMICAL_RECIPES.recipeBuilder().duration(1200).EUt(30).inputs(MetaItems.EPOXY_BOARD.getStackForm()).input(OrePrefix.foil, Materials.Electrum, 8).fluidInputs(Materials.SodiumPersulfate.getFluid(1000)).outputs(NPUMetaItems.ADVANCED_BOARD.getStackForm()).buildAndRegister();
        RecipeMaps.CHEMICAL_RECIPES.recipeBuilder().duration(1200).EUt(30).inputs(MetaItems.EPOXY_BOARD.getStackForm()).input(OrePrefix.foil, Materials.Electrum, 8).fluidInputs(NPUMaterials.IronChloride.getFluid(500)).outputs(NPUMetaItems.ADVANCED_BOARD.getStackForm()).buildAndRegister();
        RecipeMaps.CHEMICAL_RECIPES.recipeBuilder().duration(1800).EUt(30).inputs(MetaItems.FIBER_BOARD.getStackForm()).input(OrePrefix.foil, Materials.AnnealedCopper, 12).fluidInputs(Materials.SodiumPersulfate.getFluid(2000)).outputs(NPUMetaItems.EXTREME_BOARD.getStackForm()).buildAndRegister();
        RecipeMaps.CHEMICAL_RECIPES.recipeBuilder().duration(1800).EUt(30).inputs(MetaItems.FIBER_BOARD.getStackForm()).input(OrePrefix.foil, Materials.AnnealedCopper, 12).fluidInputs(NPUMaterials.IronChloride.getFluid(1000)).outputs(NPUMetaItems.EXTREME_BOARD.getStackForm()).buildAndRegister();
        ...
        // NanoMuscle Suite
        RecipeMaps.ASSEMBLER_RECIPES.recipeBuilder().duration(1200).EUt(512).input("circuitAdvanced",  1).inputs(MetaItems.CARBON_PLATE.getStackForm(7), MetaItems.BATTERY_RE_HV_LITHIUM.getStackForm()).outputs(NPUMetaItems.NANO_MUSCLE_SUITE_CHESTPLATE.getStackForm()).buildAndRegister();
        RecipeMaps.ASSEMBLER_RECIPES.recipeBuilder().duration(1200).EUt(512).input("circuitAdvanced",  1).inputs(MetaItems.CARBON_PLATE.getStackForm(6), MetaItems.BATTERY_RE_HV_LITHIUM.getStackForm()).outputs(NPUMetaItems.NANO_MUSCLE_SUITE_LEGGINS.getStackForm()).buildAndRegister();
        RecipeMaps.ASSEMBLER_RECIPES.recipeBuilder().duration(1200).EUt(512).input("circuitAdvanced",  1).inputs(MetaItems.CARBON_PLATE.getStackForm(4), MetaItems.BATTERY_RE_HV_LITHIUM.getStackForm()).outputs(NPUMetaItems.NANO_MUSCLE_SUITE_BOOTS.getStackForm()).buildAndRegister();
        RecipeMaps.ASSEMBLER_RECIPES.recipeBuilder().duration(1200).EUt(512).input("circuitAdvanced",  2).inputs(NPUMetaBlocks.TRANSPARENT_CASING.getItemVariant(CasingType.REINFORCED_GLASS), MetaItems.SENSOR_HV.getStackForm(2), MetaItems.EMITTER_HV.getStackForm(2), MetaItems.CARBON_PLATE.getStackForm(4), MetaItems.BATTERY_RE_HV_LITHIUM.getStackForm()).outputs(NPUMetaItems.NANO_MUSCLE_SUITE_HELMET.getStackForm()).buildAndRegister();
